...
@app.route('/sitevisit/createBulk', methods=['POST','GET'])
def CreateVisitOrderBulk():
    ...
    for i in data:
        ...
        # UserName = "Creating Visit Order"
        # Office = i["Office"]
        # PremiseNumber = i["Pnum"]
        # SubscriptionNumber = i["SSNum"]
...
def CheckAlfMeter():
    ...
    return render_template("GeneralMessage.html",msgcolor = "Red", MSGBody="Nothing found for Meter Number "+ str(SearchData), MsgTitle="Meter Check", BackTo= "/AlfMeter" )
